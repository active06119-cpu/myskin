  ...
  return (
    <div className="product-comparison">
      ...
      <div className="my-4 flex justify-center">
        <div className="w-full max-w-3xl bg-white border border-gray-100 rounded-3xl shadow-sm px-6 py-4">
          <p className="text-center text-xs md:text-sm text-gray-800 leading-relaxed">
